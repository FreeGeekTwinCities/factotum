...
The easiest way to install, once you have CouchDB running, is to take advantage of its replication features - either download and run the [replicate-iriscouch script](./replicate-iriscouch.sh):
