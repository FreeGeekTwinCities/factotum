...
exports.transaction = new Type('transaction', {
    fields: {
        ...
        date: {
            ...
            month: fields.string({default_value: function (req) {return new Date().getMonth()+1;}}),
...
exports.timesheet_line = new Type('timesheet_line', {
	...
	work_type: fields.choice({values: {"build": "Build", "recycling": "Recycling", "testing": "Testing", "sales": "Sales", "admin": "Administrivia"}}),        audit: {
            creator: fields.creator({required: false}),
