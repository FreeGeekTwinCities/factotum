...
exports.timesheet_line = new Type('timesheet_line', {
    fields: {
        ...
        hours: fields.number({hint: "Round your time to the nearest quarter hour (15 min.) - for example, if you spent about 2 hours and 40 minutes on something, enter '2.75'"}),
...
exports.user = new Type('user', {
    fields: {
        ...
        roles: fields.array({required: false}),
        password_sha: fields.string({required: false}),
