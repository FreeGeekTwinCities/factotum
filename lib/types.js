...
exports.transaction = new Type('transaction', {
    fields: {
        ...
        date: fields.array({hint: "Dates should be entered in 'year,month,day' format - months start at zero, so June 16, 2012 would be entered as '2012,5,16'", default_value: function (req) {return [new Date().getFullYear(), new Date().getMonth(), new Date().getDate()];}}),
        audit: {
